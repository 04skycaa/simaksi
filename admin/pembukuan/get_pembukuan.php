...
$pemasukan_data = supabase_request('GET', 'pemasukan?select=*,tanggal_pemasukan,keterangan,jumlah&is_deleted=eq.false');
$pengeluaran_data = supabase_request('GET', 'pengeluaran?select=*,id_pengeluaran,id_kategori,keterangan,jumlah,tanggal_pengeluaran,kategori_pengeluaran(nama_kategori)&is_deleted=eq.false'); 
    ...
    document.body.addEventListener('click', function(e) {
        if (e.target.closest('.btn-delete')) {
            ...
            Swal.fire({
                ...
                text: "Anda yakin ingin mengarsipkan (soft delete) data pengeluaran ini?",
                icon: 'warning',
